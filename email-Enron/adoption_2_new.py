...
abandon_rate = (1 - theta_coeff) * beta_ii + theta_coeff * beta_iii
...
# 保存数据
# np.savez_compressed('saved_data_compressed.npz',
#                     adj_matrix_o=adj_matrix.toarray(),
#                     adj_matrix_x=adj_matrix_1.toarray(),
#                     x0=x0,
#                     o0=o0,
...
#                     beta_iii=beta_iii)
# # 加载数据
# loaded_data = np.load('saved_data_compressed.npz')
#
# # 访问保存的数组
# adj_matrix_loaded = loaded_data['adj_matrix']
# x0_loaded = loaded_data['x0']
# o0_loaded = loaded_data['o0']
# abandon_rate_loaded = loaded_data['abandon_rate']
# beta_ii_loaded = loaded_data['beta_ii']
# beta_iii_loaded = loaded_data['beta_iii']