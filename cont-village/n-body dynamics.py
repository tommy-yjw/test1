...
with tqdm(total=7, desc="Solving ODE") as pbar:
    x_sol_2, info_2 = odeint(dynamics2, x0, t, args=(laplacian_matrix,), full_output=1)
    pbar.update(1)
    x_sol_3, info_3 = odeint(dynamics3, x0, t, args=(laplacian_matrix, df_list, node_index_list, lambda_coeffs), full_output=1)
    pbar.update(1)
    x_sol_4, info_4 = odeint(dynamics4, x0, t, args=(laplacian_matrix, df_list, node_index_list, lambda_coeffs), full_output=1)
    pbar.update(1)
    x_sol_5, info_5 = odeint(dynamics5, x0, t, args=(laplacian_matrix, df_list, node_index_list, lambda_coeffs), full_output=1)
    pbar.update(1)
    x_sol_6, info_6 = odeint(dynamics6, x0, t, args=(laplacian_matrix, df_list, node_index_list, lambda_coeffs), full_output=1)
    pbar.update(1)
    x_sol_7, info_7 = odeint(dynamics7, x0, t, args=(laplacian_matrix, df_list, node_index_list, lambda_coeffs), full_output=1)
    pbar.update(1)
    x_sol_8, info_8 = odeint(dynamics8, x0, t, args=(laplacian_matrix, df_list, node_index_list, lambda_coeffs), full_output=1)
    pbar.update(1)
