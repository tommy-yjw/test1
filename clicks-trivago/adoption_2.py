...
def dynamics_2(y, t, adj_matrix, laplacian_matrices_1, laplacian_matrix_1, laplacian_matrices_2, abandon_rate, theta_coeff,
    ...
    for i, B_i in enumerate(laplacian_matrices_2):
        o_dot[i] = -lambda_coeff * laplacian_matrix_1[i].dot(o) - (1 - lambda_coeff) * o.T.dot(B_i.dot(o)) + gamma * x[i] - o[i]
...
with tqdm(total=2, desc="Solving ODEs") as pbar:
    ...
    pbar.update(1)
    y_sol_2 = odeint(dynamics_2, y0, t, args=(adj_matrix, laplacian_matrices_1, laplacian_matrix_1, laplacian_matrices_2,  abandon_rate, theta_coeff, lambda_coeff, gamma, beta_ii, beta_iii))
    pbar.update(1)
